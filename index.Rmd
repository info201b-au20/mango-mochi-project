...
Unemployment_summary %>% 
  ...
  select(Year, Men, Women, Bachelor_Degree_or_Higher, High_School_Grad, Some_High_School)
Unemployment_summary %>% 
  filter(Year > 2016 | Year > 2007 & Year < 2012) %>% 
  select(Year, Some_College_or_Associate_Degree, Asian, Black_or_African_American, Hispanic_or_Latino, White)
